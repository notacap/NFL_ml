...
def process_player_rushing_data(db: DatabaseConnector, df: pd.DataFrame, season_id: int, week_id: int, interactive: bool = True) -> pd.DataFrame:
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python plyr_rush.py                    # Run with interactive player selection (default)
...
def main():
    ...
    try:
        ...
        processed_df = process_player_rushing_data(db, consolidated_df, season_id, week_id)
