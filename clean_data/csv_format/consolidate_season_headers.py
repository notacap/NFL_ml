...
def get_source_directories():
    ...
    directories = [
        f'{base_path}\plyr_def\week_{WEEK}',
        f'{base_path}\plyr_adv_def\week_{WEEK}',
        f'{base_path}\plyr_adv_passing\week_{WEEK}',
        f'{base_path}\plyr_adv_receiving\week_{WEEK}',
        f'{base_path}\plyr_adv_rushing\week_{WEEK}',
        f'{base_path}\plyr_receiving\week_{WEEK}',
        f'{base_path}\plyr_rushing\week_{WEEK}',
        f'{base_path}\plyr_rz_passing\week_{WEEK}',
        f'{base_path}\plyr_rz_receiving\week_{WEEK}',
        f'{base_path}\plyr_rz_rushing\week_{WEEK}',
        f'{base_path}\plyr_scoring\week_{WEEK}',
        f'{base_path}\plyr_scrimmage\week_{WEEK}',
        f'{base_path}\\tm_adv_passing\\tm_accuracy\week_{WEEK}',
        f'{base_path}\\tm_adv_passing\\tm_airyards\week_{WEEK}',
        f'{base_path}\\tm_adv_passing\\tm_pass_playtype\week_{WEEK}',
        f'{base_path}\\tm_adv_passing\\tm_pass_pressure\week_{WEEK}',
        f'{base_path}\\tm_def\week_{WEEK}',
        f'{base_path}\\tm_def_con_against\week_{WEEK}',
        f'{base_path}\\tm_def_drives_against\week_{WEEK}',
        f'{base_path}\\tm_def_vs_qb\week_{WEEK}',
        f'{base_path}\\tm_def_vs_te\week_{WEEK}',
        f'{base_path}\\tm_def_vs_wr\week_{WEEK}',
        f'{base_path}\\tm_defense_vs_rb\week_{WEEK}',
        f'{base_path}\\tm_off\week_{WEEK}',
        f'{base_path}\\tm_dr_avg\week_{WEEK}',
