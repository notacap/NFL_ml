...
# Configure logging
log_file = LOG_DIR / "baseline_xgb_optimized_v2_training.log"
logging.basicConfig(
    level=logging.INFO,
...
def train_refined_xgboost(X_train, y_train, X_val, y_val, param_distributions):
    ...
    hyperparams_path = MODEL_DIR / "baseline_xgb_optimized_v2_hyperparameters.json"
...
def evaluate_model(model, X_train, X_val, y_train, y_val):
    ...
    # Save metrics
    metrics_path = EVAL_DIR / "xgb_optimized_v2_metrics.json"
...
def save_model(model, imputer):
    ...
    if hasattr(model, 'evals_result'):
        ...
        history_path = MODEL_DIR / "baseline_xgb_optimized_v2_training_history.json"
